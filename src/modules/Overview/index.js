  ...
  return (
    <div>
      ...
      {selectedButton === 'Last 7 Days' && (
        <BarChart data={chartData} title="Last 7 Days Traffic" greeenBars={true} />
      )}

      {selectedButton === 'Last 30 Days' && (
        <BarChart data={chartData30} title="Last 30 Days Traffic" greenBars={true} />
      )}

      {selectedButton === 'Last 60 Days' && (
        <BarChart data={chartData60} title="Last 60 Days Traffic" greenBars={true} />
      )}

      {selectedButton === 'Custom' && (
        <BarChart data={chartDataCustom} title="Custom Traffic" greenBars={true} />
      )}
